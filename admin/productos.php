        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="editar_producto.php?id=<?= $p['id'] ?>" class="btn btn-edit">✏️ Editar</a>
                        <a href="eliminar_producto.php?id=<?= $p['id'] ?>" class="btn btn-delete" onclick="return confirm('¿Eliminar este producto?')">❌ Eliminar</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
